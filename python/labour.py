...
with open("data/labour_force.csv") as csvfile:
...
# with open("data/labour_force_new.csv", "w", newline="") as csvfile:
#     dict_writer = csv.DictWriter(csvfile, labour_force_new[0].keys())
#     dict_writer.writeheader()
#     dict_writer.writerows(labour_force_new)

with open("data/marital_status.csv") as csvfile:
...
a = pandas.read_csv("data/labour_force_new.csv")
b = pandas.read_csv("data/marital_status_new.csv")
